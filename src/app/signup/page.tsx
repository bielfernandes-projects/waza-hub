    ...
    <div className="p-8 flex flex-col items-center justify-center bg-neutral-100 min-h-screen">
      ...
      <div className="w-full max-w-sm bg-white border-4 border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col">
            <label className="font-bold text-sm uppercase mb-1" htmlFor="password">Senha Forte</label>
            <input 
              id="password" 
              name="password" 
              type="password" 
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="mt-4 border-4 border-red-600 bg-red-600 text-white font-black uppercase py-3 hover:bg-white hover:text-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
